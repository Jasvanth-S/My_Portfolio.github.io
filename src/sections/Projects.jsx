                ...
                <div className="relative w-full overflow-visible">
                    ...
                    {siteData.signatureProjects.length > 1 && (
                        <>
                            <button 
                                onClick={() => scroll('left')}
                                className="absolute left-1 sm:-translate-x-1/2 top-1/2 -translate-y-1/2 md:translate-x-4 lg:-translate-x-12 z-30 bg-white/70 dark:bg-secondary/70 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] border-t border-white/5 text-primary p-2 xl:p-4 rounded-full shadow-lg border border-gray-200 dark:border-gray-800 hover:scale-110 hover:bg-primary hover:text-white transition-all flex"
                            ...
                            <button 
                                ...
                                className="absolute right-1 sm:translate-x-1/2 top-1/2 -translate-y-1/2 md:-translate-x-4 lg:translate-x-12 z-30 bg-white/70 dark:bg-secondary/70 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] border-t border-white/5 text-primary p-2 xl:p-4 rounded-full shadow-lg border border-gray-200 dark:border-gray-800 hover:scale-110 hover:bg-primary hover:text-white transition-all flex"
                    ...
                    <div 
                        ...
                        className="flex overflow-x-auto gap-4 sm:gap-12 pb-16 pt-8 px-4 sm:px-8 md:px-[15%] snap-x snap-mandatory hide-scroll items-center"
                    >
                        {siteData.signatureProjects.map((project, index) => (
                            <div
                                key={index}
                                className={`flex-none w-[85vw] sm:w-[450px] lg:w-[500px] xl:w-[550px] snap-center transition-all duration-500 ease-out z-20 ${
                                    index === activeIndex 
                            ...
                            >
                                <div className="bg-white/70 dark:bg-secondary/70 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] border-t border-white/5 rounded-xl overflow-hidden shadow-lg border border-gray-200 dark:border-gray-800 hover:border-primary/50 transition-all duration-300 group flex flex-col h-full">
                                    {/* Project Image */}
                                        ...
                                        <div className="absolute inset-0 bg-black/60 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-center justify-center space-x-4">
                                            {project.github && (
                                                <a
                                                    ...
                                                    className="p-3 bg-gray-800/80 dark:bg-secondary/70 backdrop-blur-xl shadow-[0_8px_32px_0_rgba(31,38,135,0.07)] border-t border-white/5 rounded-full text-white hover:text-primary hover:bg-white dark:hover:bg-white transition-colors"
                                                >
                                                    <FaGithub size={20} />
                                                </a>
                                            )}
